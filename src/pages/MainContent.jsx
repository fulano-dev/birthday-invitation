      ...
      <div className="relative">
        ...
        {mostrarModalConvite && convidados && convidados.length > 0 && (
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            <div className="bg-[#0d2931] p-6 rounded-xl max-w-lg w-full text-center space-y-4 text-[#FFDE59] font-['TexGyreTermes'] shadow-lg">
              {hoje < inicioConfirmacao && (
                <>
                  <Volume2 className="mx-auto w-10 h-10 text-[#FFDE59]" />
                  ...
                  <p className="text-sm mt-2 italic text-[#FFDE59]/80">
                    Gostou do kit-convite? Tá liberado postar! 📸 
                  </p>
                  <p className="text-sm mt-2 italic text-[#FFDE59]/80">Se quiser compartilhar, marque <strong>@joaovargas.jpg</strong> ao postar nos stories! 😉</p>
              ...
              {hoje >= inicioConfirmacao && hoje <= fimConfirmacao && !confirmados && (
                <>
                  <Info className="mx-auto w-10 h-10 text-[#FFDE59]" />
              ...
              {hoje >= inicioConfirmacao && hoje <= fimConfirmacao && confirmados && (
                <>
                  ...
                  <p className="text-sm text-[#FFDE59]">Você confirmou presença para:</p>
              ...
              {hoje > fimConfirmacao && !confirmados ? (
                <button
                  className="mt-4 px-4 py-2 bg-[#FFDE59] text-black rounded-md hover:bg-[#bfa67e] transition"
